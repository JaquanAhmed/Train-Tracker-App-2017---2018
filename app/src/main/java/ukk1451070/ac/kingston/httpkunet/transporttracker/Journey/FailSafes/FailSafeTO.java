...
public class FailSafeTO extends AppCompatActivity {

    private String TAG = FailSafeTO.class.getSimpleName();
    ...
    private class GetLocations extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(FailSafeTO.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    String fpn = p.getString("name") + p.getString("vicinity");

                    ArrayList<LatLng> full = (ArrayList<LatLng>) extras.get("full");

                    Intent intent = new Intent(FailSafeTO.this, TJPartOrigin.class);
