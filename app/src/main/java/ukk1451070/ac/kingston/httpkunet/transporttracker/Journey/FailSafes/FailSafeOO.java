...
public class FailSafeOO extends AppCompatActivity {
    ...
    private class GetLocations extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(FailSafeOO.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    ArrayList<LatLng> full = (ArrayList<LatLng>) extras.get("full");
                        ...
                        Intent intent = new Intent(FailSafeOO.this, OJPartDestination.class);
                        ...
                        intent.putExtra("FLon", l.getDouble("lng"));
                        intent.putExtra("FLat", l.getDouble("lat"));
