...
public class TJPartDestination extends AppCompatActivity {

    private String TAG = TJPartDestination.class.getSimpleName();
    ...
    private class GetStations extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(TJPartDestination.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "http://transportapi.com/v3/uk/places.json?query="+extras.getString("tpn")+"&type=train_station&app_id=30df19a0&app_key=d860f66065dfff6c84237c6836ae2e66";
                ...
                try {
                    ...
                    for (int i = 0; i < stations.length(); i++) {
                        ...
                        if (c.getDouble("latitude")<50||c.getDouble("latitude")>52){
                            Intent intent = new Intent(TJPartDestination.this, FailSafeTD.class);
                        ...
                        Intent intent = new Intent(TJPartDestination.this, TJPartRoute.class);
                        intent.putExtra("partNo", getIntent().getIntExtra("partNo", 0));
                        intent.putExtra("endNo", getIntent().getIntExtra("endNo", 0));
                        intent.putExtra("FLon", getIntent().getDoubleExtra("FLon", 0));
                        intent.putExtra("FLat", getIntent().getDoubleExtra("FLat", 0));
                        ...
                        intent.putExtra("SC2", c.getString("station_code"));
                        intent.putExtra("full", full);
                        startActivity(intent);
                    }
