...
public class OriginSearch extends AppCompatActivity {
    AutoCompleteTextView places;
    MyPlacesAdapter adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.originsearchform);
        places=(AutoCompleteTextView)findViewById(R.id.places);
        adapter=new MyPlacesAdapter(OriginSearch.this);
    ...
    {
        Intent intent = new Intent(OriginSearch.this, DestinationSearch.class);
