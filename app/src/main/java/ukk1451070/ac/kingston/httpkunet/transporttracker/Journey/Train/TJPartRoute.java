...
public class TJPartRoute extends AppCompatActivity {

    private String TAG = TJPartRoute.class.getSimpleName();
    ...
    private class GetRoutes extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(TJPartRoute.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "https://transportapi.com/v3/uk/public/journey/from/lonlat:"+Double.toString(extras.getDouble("FLon"))+","+Double.toString(extras.getDouble("FLat"))+"/to/lonlat:"+Double.toString(extras.getDouble("TLon"))+","+Double.toString(extras.getDouble("TLat"))+".json?app_id=30df19a0&app_key=d860f66065dfff6c84237c6836ae2e66&modes=train";
                ...
                try {
                    ...
                    for (int i = 0; i < route_parts.length(); i++) {
                        ...
                        for (int i2 = 0; i2 < coordinates.length(); i2++) {
                            ...
                            if (rp.getString("mode").equals("train")) {
                                train.add(latLng);
                            }
                        }
                    }
                        Intent intent = new Intent(TJPartRoute.this, Live.class);
